...
- [x] Home Quick Capture
- [x] 今日任务卡片
- [x] 最近想法
- [x] 待澄清事项
- [x] 最近草稿
- [ ] 全局搜索入口
- [ ] Toast 反馈（已有 Loading 和 Error 状态）
- [x] Loading 状态（页面级自动）
- [x] Empty 状态（各列表页面已实现）
- [ ] Error 状态（API 层已统一，页面路由级待补充）
- [ ] 完整闭环演示测试

### 当前状态

Milestone 6 核心功能已完成：
- 数据仪表盘：统计卡片（今日任务、最近想法、待澄清、草稿数）
- 首页 Quick Capture（复用 Inbox 组件）
- 三列工作流概览：今日任务、最近想法、最近草稿
- 待澄清想法横条区域（高亮提醒）
- 所有列表均有 Empty 状态兜底
- 所有跳转链接已打通
